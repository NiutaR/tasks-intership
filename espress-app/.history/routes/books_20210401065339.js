...
const crudApp = () => {
  this.myBooks = [
    ...
    { ID: '1', Book_Name: 'A Children’s Bible', Author: 'Lydia Millet', Collection: 'A Children’s Bible', Release: '2020' },
    { ID: '2', Book_Name: 'A Children’s Bible', Author: 'Lydia Millet', Collection: 'A Children’s Bible', Release: '2020' },
